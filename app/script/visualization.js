    ...
    return {
        ...
        draw: function () {
            d3.json("data/geodata.json", function(error, data){
                ...
                var projection = d3.geoMercator().scale(width/11).translate([width/2, (height/2)+100]);
                ...
                function handleMouseClickContinent(continent) {
                    ...
                    case"World":
                        ...
                        switch(continent){
                        case"Europe":
                            transformString = "translate(-2200,-600)scale(3)";
                            break;
                        case"North America":
                    ...
                    case"Continent":
                        ...
                        switch(continent){
                        case"Europe":
                            transformString = "translate(2200,600)scale(1/3)";
                            break;
                        case"North America":
